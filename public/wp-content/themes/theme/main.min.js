...
Version   | V 1.0.0             
+---------+---------------------+
Released  | Tue Dec 11 2018 16:39:11 GMT+0000 (GMT)            
+---------+---------------------+
*/

console.log(`%cBuilt with ♥ by Alex Wiley`, 'font-family:monospace;color: #4C2A80;font-size: 14px;'); console.log(`%cStart a conversation`, 'font-family:monospace;font-size: 13px;font-weight: bold;'); console.log(`%chttps://alexwiley.co.uk`, 'font-family:monospace;font-size: 12px;'); console.log(`%chello@alexwiley.co.uk`, 'font-family:monospace;font-size: 12px;color: #4C2A80;');const global = {
  showMenu: false,
  menuState: 'closed'
};
